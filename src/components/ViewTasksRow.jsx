...
const ViewTasksRow = ({ task, index }) => {
  const { taskName, description, dueDate, user } = task;
  ...
  return (
    <tr class="  shadow-2xl text-[#000000] text-lg    shadow-gray-200   ">
      ...
      <td className="px-6 py-4">
        <HiOutlineDotsVertical className=" text-xl hover:cursor-pointer" onClick={()=>handleActions()}/>
      </td>
    </tr>
  );
};
